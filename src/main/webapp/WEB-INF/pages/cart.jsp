...
<form name="myFrom" id="myFrom" method="post" action="/order/sub.html">
    ...
    <div class="dingdan">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
            ...
            <tr>
                <td height="95" align="center">
                    <div class="contact_way_img"><img src="${order.mobile.img}" width="56" height="42"></div>
                    <div class="contact_way_txt"><p><span>${order.mobile.mobileName}</span></p></div>
                    <div class="clear"></div>
                </td>
                ...
                <td style="padding-left:28px; line-height: 18px;text-align: left;">
		  								<span>
									${order.basicSituation}
								</span>
                    <br />

                    <span>
									${order.functionalSituation}${order.wearDegree}
								</span>
        ...
        <div class="foot_bor"> <em>${count}</em>件产品总计回收价格<em style="font-size:18px;">￥${result}</em> <!--<span>赠送环保券 <i>30</i>元--></span></div>
    </div>
    <!--订单-->
    </div>
    <!--提交订单-->
