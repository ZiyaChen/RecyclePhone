...
<head>
    ...
    <title>${phone.mobileName}-回购网 -  手机回收网 | 二手手机交易 | 笔记本回收 | 平板回收</title>
...
<div class="recovery">
    <div class="page2">
        <div class="heat_l" style="width:276px;">
            <div class="heat_img"><img src="${phone.img}" width="264" height="197" /></div>
        </div>
        <div class="heat_new">
            <input type="hidden" name="typeid" id="typeid" value="1" />
            <dl>
                <dt><span>请选择一种回购方式</span><a href="phoneInfo/mobileInfo/${phone.id}">重新评估</a></dt>
                <dd class="clearfix heat_on" name="1">
                    <div class="heat_yellow"> <img src="images/new_jian.png" class="new_jian" />
                        ...
                        <div class="yellow_r"> <span>全网最高</span>
                            <div id="pg_price" class="digits">${phonePrice}</div>
                            <span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;官方直收</span>
                            <div class="clear"></div>
                        </div>
                    </div>
                    <input type="button" value="立即下单" class="heat_input" onclick="addOrder()" />
                    <a href="javascript:;" class="heat_hg" onclick="addcart()">加入回购车</a> </dd>
            </dl>
...
<script type="text/javascript">
    ...
    function addcart() {
        ...
        $.get("showPrice/saveGoods/${shoppingCart.id}/"+userId,{},function (data) {
            alert("添加成功");
            loadCar()
        })
    }
    function loadCar() {
        $.post("showPrice/loadDataCart",{},function (data) {
            $("#cart_tbody").empty();
            var all_price=0;
            var count=0;
    ...
    function addOrder() {
        ...
        if(userId==null||userId==""){
            ...
            window.location.href="cart/cartInfo/"+userId;
        }
    }
