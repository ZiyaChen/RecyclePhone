...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="login_files/global.css" rel="stylesheet" type="text/css">
    <link href="login_files/eject.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="login_files/jquery.js"></script>
    <script type="text/javascript" src="login_files/public.js"></script>
    <script type="text/javascript" src="login_files/all.js"></script>
    ...
    <script type="text/javascript" src="login_files/checkData.js"></script>
    <script type="text/javascript" src="login_files/jqBackgroundPositionAnimate.js"></script>
        ...
        $(document).ready(function(){
            ...
            $('#mtl_submit_re').click(function(){
                ...
                if(check_register_data()&& V('status','v') == 1){
                    var form = V('reg','o');
                    form.attr('action',"http://www.mitaole.com/members/register.html")
                    form.submit();
                }else{
                    return false;
                }
...
<div class="login_main">
    <div class="login_title">
        <a href="javascript:;" class="login_btn" style="width: 264px;">登录</a><a href="javascript:;" class="register_btn" style="width: 125px;">注册</a>
        <div class="clear"></div>
    </div>
    <div class="register" style="display: none;">
        <form method="POST" id="reg">
            ...
            <div class="c1">
                <span class="c1_span"><img src="login_files/login_icon3.gif"></span>
                <input type="text" value="邮箱" class="input_txt" id="register_user" name="register_user">
                <div class="login_tip" id="re_user"><span></span></div>

                <div class="clear"></div>
            </div>
            <div class="c1"><span class="c1_span"><img src="login_files/login_icon2.gif"></span>
                <label>
                    <samp id="register_pwd_html">设置密码</samp>
                    <input type="password" maxlength="16" value="" class="input_txt" id="register_pwd" name="register_pwd">
                </label>
        ...
        <div class="fast_login">
            ...
            <a href="javascript:open_link_pop(&#39;https://api.weibo.com/oauth2/authorize?client_id=3875553626&amp;redirect_uri=http%3A%2F%2Fwww.mitaole.com%2Fapi%2Fsina_callback&amp;response_type=code&amp;state=a20eac122a8878a1e882397752255578&#39;);"><img src="login_files/login_sina.png"></a>
            <a href="javascript:open_link_pop(&#39;http://www.mitaole.com/api/qq_url.html&#39;);"><img src="login_files/login_QQ.png"></a>
            <a href="javascript:open_link_pop(&#39;http://www.mitaole.com/weixin_login/create_login_qrcode.html&#39;);"><img src="login_files/login_wx.png"></a>
        </div>
    </div>
    <div class="login" style="display: block;">
        <form id="login" method="POST">
            ...
            <div class="c1"><span class="c1_span"><img src="login_files/login_icon1.gif"></span>
            ...
            <div class="c1"><span class="c1_span"><img src="login_files/login_icon2.gif"></span><label><samp id="l_password_html">密码</samp><input type="password" value="" class="input_txt" id="l_pwd" name="login_password"></label>
                <div class="clear"></div>
            </div>
